...
__export(src_exports, {
  defaultThemeFontSizeInRems: () => defaultThemeFontSizeInRems,
  defaultThemeScreensInRems: () => defaultThemeScreensInRems,
  fluidCorePlugins: () => fluidCorePlugins,
  fluidExtractor: () => extractor_default,
  fluidize: () => fluidize
});
...
var fluidCorePlugins = (0, import_plugin.default)((api) => {
  var _a3;
  ...
  const fontSizeValues = (0, import_map_obj2.default)(
    ...
    (k, v) => {
      ...
      return Length.parse(fontSize) ? [k, v] : import_map_obj2.mapObjectSkip;
    }
  );
...
var _a;
var defaultThemeScreensInRems = (0, import_map_obj2.default)((_a = import_defaultTheme.default.screens) != null ? _a : {}, (name, v) => {
  if (typeof v !== "string")
    return [name, v];
  const len = Length.parse(v);
  if (!len || len.unit !== "px")
...
var _a2;
var defaultThemeFontSizeInRems = (0, import_map_obj2.default)(
